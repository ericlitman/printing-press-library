...
var whichIndex = []whichEntry{
	...
	{Command: "issues edit --trust-mode strict", Description: "Refuse issue edits outside the local pp_created ledger when --trust-mode strict is set.", Group: "Agent-native plumbing", WhyItMatters: "Reach for this when running an agent against a real workspace with real data — strict mode blocks edits to issues the CLI did not create."},
}
